...
import { Eye, EyeClosed, Loader2, Lock, Mail, UserRound } from "lucide-react";
        ...
        <div className='max-w-screen-lg flex items-center justify-center mx-auto w-full p-4 mt-16'>
            <Card className="w-full max-w-md">
                <CardHeader>
                    ...
                    <CardDescription>Enter your username or email to receive a password reset OTP</CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <div className='space-y-2'>
                            <div className="relative grid grid-cols-[3fr_1fr] items-center gap-4">
                                ...
                                <Button
                                    ...
                                    disabled={!user || cooldown > 0 || isSendingOtp || !isValidIdentifier}
                                >
                                    {isSendingOtp ? (
                                        <>
